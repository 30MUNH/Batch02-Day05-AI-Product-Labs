...
|---|---|---|
| | Đổi user chính | no |
| | Đổi pain statement | no |
| | Đổi build slice | yes |
| | Đổi Auto/Aug decision | yes |
| | Đổi 4 paths | no |
| | Đổi failure mode | yes |
| | Đổi owner/test plan | yes  |
...
**Lý do:**
Đảm bảo **tính thực tế** (khoảng cách) và **tính an toàn tuyệt đối** (dị ứng) — những điểm yếu chí mạng của các mô hình LLM nếu để chúng tự do sinh kết quả. Việc dùng dataset nhỏ (10–20 món) cũng giúp dự án **dễ hoàn thành trong khuôn khổ Mini Hackathon.**
